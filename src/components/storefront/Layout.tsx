    ...
    <div className="min-h-screen pb-20 md:pb-0" dir={"rtl"}>
      <header className="sticky top-0 z-40 bg-glass/80 backdrop-blur-md">
        <div className="section-shell flex h-20 items-center gap-4">
          ...
          <Link
            to="/"
            className="me-2 font-script text-4xl text-secondary link-focus"
          >
            Labella
          </Link>
          ...
          <form
            onSubmit={submit}
            className="hidden max-w-xs flex-1 items-center gap-2 rounded-full border border-border bg-background/60 px-3 py-1.5 lg:flex"
          >
